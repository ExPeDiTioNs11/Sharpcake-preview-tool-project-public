...
export default function CampaignDetail() {
  ...
  const sendCategoryRequest = async (category_id) => {
    try {
      ...
      const response = await axios({
        method: 'GET',
        url: `https://sharpcakepreviewproject-b590a1ae7543.herokuapp.com/api/category/get-by-categoryInSubCategories-shareLink/${category_id}`,
        headers: {
      ...
      const responseTwo = await axios({
        method: 'GET',
        url: `https://sharpcakepreviewproject-b590a1ae7543.herokuapp.com/api/category/get-by-categoryID-shareLink/${category_id}`,
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  useEffect(() => {
    const makeApiRequest = async () => {
      try {
        ...
        const response = await axios({
          method: 'GET',
          url: `https://sharpcakepreviewproject-b590a1ae7543.herokuapp.com/api/campaign/get-by-campaignID-shareLink/${id}`,
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
        });

        // session storage verilerine brand logo img değeri atanır ve navbarLogined companentinden bu veri alınarak marka logo alınana basılır ve markanın logosu campaing detail page e
        // girildiğinde gösterilir.
    ...
    const filePathDescRequest = async () => {
      ...
      const response = await axios({
        method: 'GET',
        url: `https://sharpcakepreviewproject-b590a1ae7543.herokuapp.com/api/category/get-all-filePathDesc-shareLink/`,
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
      ...
      if (response.data && response.data.filePathDescs) {
        console.log(response.data.filePathDescs)
  ...
  const getSubCategoryById = (subCategoryId) => {
    ...
    const settings = {
      method: 'GET',
      url: `https://sharpcakepreviewproject-b590a1ae7543.herokuapp.com/api/category/subCategory/get-by-subCategoryID-shareLink/${subCategoryId}`,
      headers: {
        Authorization: `Bearer ${accessToken}`
      }
    };
                      ...
                      <div>
                        {[0, 1, 2].map(textareaIndex => (
                          ...
                          <div key={textareaIndex}>
                            <span style={{ marginLeft: '10px' }}>{textareaIndex === 0 ? `Voice Over` : textareaIndex === 1 ? `Super` : `Description`}</span>
                            <textarea
                              rows="4"
                              cols="50"
                              placeholder={
